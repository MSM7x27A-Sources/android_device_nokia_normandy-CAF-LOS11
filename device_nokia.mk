...
PRODUCT_COPY_FILES += \
device/nokia/normandy/recovery/sbin/charge_recovery:/recovery/root/sbin/charge_recovery \
device/nokia/normandy/recovery/sbin/rmt_storage_recovery:/recovery/root/sbin/rmt_storage_recovery \
device/nokia/normandy/recovery/sbin/rmt_oeminfo_recovery:/recovery/root/sbin/rmt_oeminfo_recovery \
...
PRODUCT_COPY_FILES += \
	...
	$(LOCAL_PATH)/config/ft6306.kl:system/usr/keylayout/ft6306.kl \
	$(LOCAL_PATH)/config/Generic.kl:system/usr/keylayout/Generic.kl \
	$(LOCAL_PATH)/config/qwerty.kl:system/usr/keylayout/qwerty.kl \
	$(LOCAL_PATH)/config/surf_keypad.kl:system/usr/keylayout/surf_keypad.kl \
	$(LOCAL_PATH)/config/synaptics_rmi4_i2c.kl:system/usr/keylayout/synaptics_rmi4_i2c.kl 
...
$(call inherit-product, vendor/nokia/xl/common-vendor.mk)
$(call inherit-product, vendor/nokia/xl/xl-vendor.mk)
